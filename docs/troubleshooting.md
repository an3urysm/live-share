...
| Tool | Problem | Resolution / Workaround |
|------|----------------|------------|
| VS | As a guest, you <strong>were not prompted / able to launch VS / VS Code</strong> after opening the join page in the browser. |  See [join manually](collab-session.md#join-manually).<br /><br /> We would also love to see your logs, so please please [log a bug](../CONTRIBUTING.md). |
